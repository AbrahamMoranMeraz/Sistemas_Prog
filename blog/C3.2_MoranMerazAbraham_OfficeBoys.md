...
<p align="center">
    <img alt="SalidaDigital" src="../img/Aurd_2_.png" width=500 height=400>
</p>

<p align="center">
    <img alt="SalidaDigital" src="../img/Aurd_2_2.png" width=500 height=400>
</p>

<p align="center">
    <img alt="SalidaDigital" src="../img/Aurd_2_1.png" width=500 height=400>
</p>

``` 
La salida que observamos por el puerto serial son 0 en su
mayoría pues al no presionar el botón no se permite el paso
de corriente por lo que arduino considera eso un 0, cuando
presionamos el botón se permite el paso de corriente y se lee 
un uno en el pin digital.
Para hacer más precisa la lectura y no detecta mas de 1 estado
alto en el pin digital se colocó un delay con 100 milisegundos.
```
